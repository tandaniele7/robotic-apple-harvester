...
class Detection(Node):
    ...
    def get_apple_pose_callback(self, request, response):
        if self.apple_ids:
            ...
            apple_pts_world = self.transform_point([x, y, z], "world",self.frame_id)
            ...
            self.qtr = multiply_quaternion(self.qtr, rot_90_y)
            self.qtr = multiply_quaternion(self.qtr, rot_180_z)
            ...
            response.message = ""
            response.success = True
            print(request.caller.data)
            if request.caller.data == "move":
    ...
    def get_transform_quaternion(self, frame_a, frame_b):
        try:
            ...
            quaternion_ = [rotation_quat.x, rotation_quat.y, rotation_quat.z, rotation_quat.w]
            return quaternion_
